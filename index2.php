...
<body>
    ...
    <div id="topMenu">
        ...
        <a href="?id=7"> <img src="/images/userHead2.png"  class="battery">Профиль</a>
    </div>
        <form id="searcher" action="?id=8" method="POST">
        <input type="text" id="searchTexter" name="texter" placeholder="Поиск">
